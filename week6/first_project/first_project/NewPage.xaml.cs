        ...
        private async void CreateButton(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                if (isCreate == true)
                {
                    ...
                    ListItem temp = new ListItem(TitleBlock.Text, DetailBlock.Text, Date.Date, result);
                ...
                {
                    BitmapImage result = NewImage.Source as BitmapImage;
                    ((App)App.Current).ViewModel.UpdateTodoItem(((App)App.Current).currentId, TitleBlock.Text, DetailBlock.Text, Date.Date,result,NewImage.Name);
                    this.Frame.Navigate(typeof(MainPage));
                }
            }
        }
